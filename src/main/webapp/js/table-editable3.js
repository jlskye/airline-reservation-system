    ...
    return {
        ...
        init: function () {
            ...
            function editRow(oTable, nRow) {
                ...
                jqTds[3].innerHTML = '<a class="cancel">取消</a>';   
                jqTds[4].innerHTML = '<input type="hidden" id="sid"   class="m-wrap small" value="' + aData[4] + '">';
            }
            ...
            function save1Row(oTable, nRow) {
                ...
                oTable.fnDraw();     
                var key = jqInputs[2].value;

                if(key != ""){
	                	$.ajax({
	                		url:"/LunaNova/train/update" ,
	                		type:"post",
	                		data:{
	                			train_name:jqInputs[0].value,
	                			train_type:jqInputs[1].value,
	                			train_id:jqInputs[2].value,
	                			m:"modify"
	                		},
	                		success:function(){                		
	                			alert("修改成功");
