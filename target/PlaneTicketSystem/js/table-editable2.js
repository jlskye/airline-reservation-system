    ...
    return {
        ...
        init: function () {
            ...
            function editRow(oTable, nRow) {
                ...
                jqTds[2].innerHTML = '<input type="text" id="arrivetime"  onclick="SelectDate(this,\'yyyy-MM-dd hh:mm:ss\')" class="m-wrap small" value="' + aData[2] + '">';
                jqTds[3].innerHTML = '<input type="text" id="departtime" onclick="SelectDate(this,\'yyyy-MM-dd hh:mm:ss\')" class="m-wrap small" value="' + aData[3] + '">';
